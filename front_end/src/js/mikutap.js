/* eslint-disable */
import {aidn} from "./common";

export function mikutap() {
    const $ = jQuery;
    ...
    var MainManager = function () {
        ...
        function n(n) {
            (U = !U) ? ($("#bt_feedback a").text("反馈: ON"),
                aidn.util.setCookie("fb", "on", 2592e3)) : ($("#bt_feedback a").text("反馈: OFF"),
                aidn.util.setCookie("fb", "off", 2592e3)),
            n && n.preventDefault()
        }

        function o(n) {
            (T = !T) ? ($("#bt_backtrack a").text("背景音乐: ON"),
                aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("背景音乐: OFF"),
        ...
        n(),
            ...
            y || $("#scene_top .attention").text("※打开声音，然后享受音乐吧")) : ($("#ng").css("display", "block"),
                $(".ok").css("display", "none"),
