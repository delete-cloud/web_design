...
aidn.init = {
    ...
    aidn.string = {
        breakStr: function (e, t, n) {
            ...
            if (!n)
                return o;
            for (var g = [], d = 0, l = o.length; d < l; d++)
                g[d] = o[d].join("");
            return g
        },
...
function __addRelease(e, t, n, i, a, o, r, d) {
    ...
    "1" != aidn.util.getCookie(d))) {
        ...
        _isJapanese || (a = o);
        for (var l = "Noto+Sans+JP:wght@500", c = !1, s = "Poppins:wght@500", u = !1, h = $("link"), f = 0, g = h.length; f < g; f++) {
            var m = h[f].getAttribute("href");
            m && (0 < m.indexOf(l) && (c = !0),
            0 < m.indexOf(s) && (u = !0))
        }
        ...
        u || (v += s),
            ...
            $("head").append(v)),
        _isJapanese || (n = i);
        var p = Date.now() + Math.floor(1e5 * Math.random())
            , v = "calc(0.7rem + 0.6vh)";
        24 <= n.length && (v = "calc(0.6rem + 0.5vh)");
        i = "bottom",
            i = "white-space: nowrap; position: fixed; " + (i = 1 == r ? "top" : i) + ": -2px; z-index: 100000; left: 50%; transform: translateX(-50%); width:100%; max-width: 480px; color: #000; background:rgb(255, 255, 255); text-align:left; cursor:pointer; letter-spacing: .4rem; line-height: 1; border: solid 1px rgba(0, 0, 0, 0.2); transition: all .12s;",
            i = '<div id="rel_open' + p + '" style="' + (i += "font-family:Poppins,'Noto Sans JP','YuGothic', 'Hiragino Kaku Gothic Pro', 'Yu Gothic', 'MS PGothic', sans-serif;") + '">';
        i += '<img src="' + e + '" style="width:calc(45px + 2.4vh); height:calc(45px + 2.4vh); margin: calc(4px + 1.0vh); margin-right: calc(6px + 1.2vh); vertical-align:middle;">',
            i += '<p style="display:inline-block; vertical-align:middle; letter-spacing:0.1rem; line-height:1.5; font-weight:500;">',
            i += '<span style="font-size:calc(0.5rem + 0.5vh); color: #f39;" class="blink">' + a + "</span><br>",
            i += '<span style="font-size:' + v + ';">' + n + "</span>",
            i += "</p>",
            i += '<p id="rel_close' + p + '" style="position:absolute; right:0; top:0; padding:1vh;">',
            i += '<svg style="width: calc(24px + 2vmin); transition: fill .12s;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>',
            i += "</p>",
            i += "</div>",
            $("body").append(i),
            i = "<style>\n.blink{\n",
            ...
            i += "</style>",
            $("head").append(i),
            $("#rel_open" + p).on("click", function (e) {
                e.preventDefault(),
                    location.href = t
            }),
            $("#rel_close" + p).on("click", function (e) {
                e.preventDefault(),
                    e.stopPropagation(),
                    $("#rel_open" + p).hide(),
    ...
    "undefined" == typeof jQuery ? setTimeout(__checkInit, 10) : ((e = window.__s) && "string" == typeof e && ($.ajax({
        ...
        $(function () {
            ...
            12.2 <= e) {
                ...
                1 != $("body").data("motion") || 2 <= (g = location.href.split("aidn")).length && (u = !0,
                    o = g[1].split("/").length - 3),
            ...
            _isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function () {
                setInterval(function () {
                    var e;
                    !document.querySelector(".goog-te-menu-frame") || null == (e = document.querySelector(".goog-te-menu-frame").contentWindow.document.querySelector("a")).onclick && (e.onclick = function (e) {
                            try {
                                document.querySelector(".goog-te-banner-frame").contentWindow.document.querySelector(".goog-close-link").click()
                            } catch (e) {
                            }
                        }
                    )
                }, 500);
                $("head").append("<style>.goog-te-gadget { margin-top:10px; margin-bottom:10px; } .goog-te-gadget a:link, .goog-te-gadget a:visited { text-decoration:none; } #google_translate_element div.skiptranslate { opacity: 1; letter-spacing:0.12rem; } #google_translate_element .goog-te-gadget-simple { padding: 6px; } body { top: 0 !important; } div.skiptranslate .goog-te-banner-frame { display: none; } </style>")
            }),
            ...
            0 < location.href.indexOf("/wow") && (f = `<p style="font-family: 'Sawarabi Gothic', sans-serif; font-size: calc(0.5rem + 0.6vmin); animation: none; margin-top: calc(15px + 1.5vmin);">[tx]</p>`,
                ...
                $("#top").append(f));
            for (var f, g, m = !1, p = "NOW ON SALE", v = "NOW ON SALE", w = "nyancat10th/", y = "daniwell/shared/img/jacket/nyancat_arrangements.png", b = "Nyan Cat Arrangements", x = "Nyan Cat Arrangements", c = [{
                path: "/nyancat/"
            }, {
                path: "/momotap"
            }, {
                ...
                if (0 < s.indexOf(k.path)) {
                    ...
                    "boolean" == typeof k.topFlag && (m = k.topFlag);
                    break
                }
            }
            ...
            _active || (g = aidn.constant.advUrlEn,
                f = "",
                f += '<a href="' + (g = aidn.util.checkJapanese() ? aidn.constant.advUrlJa : g) + '" target="_blank"><div class="adv_con">',
                f += '<p class="text">' + aidn.constant.advTex + "</p>",
                f += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>',
                f += "</div></a>",
            0 < (g = $("#common_back")).length && (f = '<div class="adv"><div class="hr_top"></div>' + f + "</div>",
...
(_active = "undefined" == typeof swfobject || swfobject.hasFlashPlayerVersion("9") && !aidn.util.checkMobile()) || (swffit.fit = function () {
    ...
    aidn.WebAudio = function () {
        aidn.audio.init();
        var h, f, g, m, p, v, w, y, b, x, _, t, k = this, E = [], O = [], S = 0, A = 100, T = -1, F = !1, n = 1, L = 1;
        ...
        this.load = function (e, u, t, n) {
            ...
            this.initPanner = function (e) {
                return 0 < (e = void 0 === e || e <= 0 ? "equalpower" : e) && (e = "HRTF"),
                    (g = I.createPanner()).panningModel = e,
                    this.nodePanner = g
            }
            ,
