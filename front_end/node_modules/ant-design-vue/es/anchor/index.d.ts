...
declare const _default: {
    new (...args: any[]): {
        ...
        $data: {};
        $props: Partial<{
            items: import("./Anchor").AnchorLinkItemProps[];
            affix: boolean;
            ...
            items: {
                type: import("vue").PropType<import("./Anchor").AnchorLinkItemProps[]>;
                default: import("./Anchor").AnchorLinkItemProps[];
            };
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "items" | "affix" | "showInkInFixed" | "wrapperStyle">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
