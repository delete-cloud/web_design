  ...
  setup: function setup(props, _ref) {
    ...
    var createNestedLink = function createNestedLink(options) {
      return Array.isArray(options) ? options.map(function (item) {
        return _createVNode(AnchorLink, _objectSpread(_objectSpread({}, item), {}, {
          "key": item.key
        }), {
    ...
    return function () {
      ...
      var inkClass = classNames("".concat(pre, "-ink-ball"), _defineProperty({}, "".concat(pre, "-ink-ball-visible"), activeLink.value));
      var wrapperClass = classNames(hashId.value, props.wrapperClass, "".concat(pre, "-wrapper"), _defineProperty({}, "".concat(pre, "-rtl"), direction.value === 'rtl'));
