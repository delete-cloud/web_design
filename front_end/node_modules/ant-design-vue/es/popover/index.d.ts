...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            onOpenChange: import("vue").PropType<(vis: boolean) => void>;
            'onUpdate:open': import("vue").PropType<(vis: boolean) => void>;
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "title" | "visible" | "content" | "open" | "align" | "builtinPlacements" | "overlayInnerStyle" | "overlayStyle" | "destroyTooltipOnHide" | "autoAdjustOverflow" | "arrowPointAtCenter">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
