...
declare const _default: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "status" | "bordered" | "includeMargin" | "imageSettings" | "errorLevel" | "iconSize">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
