...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var popupClassName = (0, _vue.computed)(function () {
      return (0, _classNames2.default)(prefixCls.value, "".concat(prefixCls.value, "-").concat(props.theme || theme.value), props.popupClassName);
    });
    ...
    return function () {
      ...
      if (!overflowDisabled.value && mode.value !== 'inline') {
        var popupOffset = mode.value === 'horizontal' ? [0, 8] : [10, 0];
