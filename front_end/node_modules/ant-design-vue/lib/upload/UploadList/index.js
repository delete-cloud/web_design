  ...
  setup: function setup(props, _ref2) {
    ...
    var actionIconRender = function actionIconRender(opt) {
      ...
      var btnProps = {
        ...
        class: "".concat(prefixCls, "-list-item-action")
      };
    ...
    var listClassNames = (0, _vue.computed)(function () {
      var _ref4;
      return _ref4 = {}, (0, _defineProperty2.default)(_ref4, "".concat(prefixCls.value, "-list"), true), (0, _defineProperty2.default)(_ref4, "".concat(prefixCls.value, "-list-").concat(props.listType), true), _ref4;
    });
    var transitionGroupProps = (0, _vue.computed)(function () {
      var motion = (0, _extends2.default)({}, (0, _collapseMotion.default)("".concat(rootPrefixCls.value, "-motion-collapse")));
      delete motion.onAfterAppear;
      delete motion.onAfterEnter;
      delete motion.onAfterLeave;
      var motionConfig = (0, _extends2.default)((0, _extends2.default)({}, (0, _transition.getTransitionGroupProps)("".concat(prefixCls.value, "-").concat(props.listType === 'picture-card' ? 'animate-inline' : 'animate'))), {
