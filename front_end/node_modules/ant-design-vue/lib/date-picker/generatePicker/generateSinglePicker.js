    ...
    return (0, _vue.defineComponent)({
      ...
      setup: function setup(_props, _ref) {
        ...
        if (process.env.NODE_ENV !== 'production') {
          (0, _devWarning.default)(picker !== 'quarter', displayName || 'DatePicker', "DatePicker.".concat(displayName, " is legacy usage. Please use DatePicker[picker='").concat(picker, "'] directly."));
        ...
        return function () {
          ...
          return wrapSSR((0, _vue.createVNode)(_vcPicker.default, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({
            ...
            "showToday": showToday,
            "locale": locale.lang,
            "class": (0, _classNames2.default)((_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(pre, "-").concat(mergedSize.value), mergedSize.value), (0, _defineProperty2.default)(_classNames, "".concat(pre, "-borderless"), !bordered), _classNames), (0, _statusUtils.getStatusClassNames)(pre, (0, _statusUtils.getMergedStatus)(formItemInputContext.status, props.status), formItemInputContext.hasFeedback), attrs.class, hashId.value, compactItemClassnames.value),
            ...
            "dropdownClassName": (0, _classNames2.default)(hashId.value, props.popupClassName, props.dropdownClassName),
            "onChange": onChange,
