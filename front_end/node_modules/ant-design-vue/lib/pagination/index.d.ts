...
declare const _default: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "onChange" | "size" | "disabled" | "responsive" | "itemRender" | "pageSizeOptions" | "buildOptionText" | "hideOnSinglePage" | "showSizeChanger" | "showLessItems" | "showQuickJumper" | "showTotal" | "simple" | "onShowSizeChange" | "onUpdate:current" | "onUpdate:pageSize">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
