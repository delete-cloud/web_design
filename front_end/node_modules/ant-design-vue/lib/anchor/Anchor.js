  ...
  setup: function setup(props, _ref) {
    ...
    var updateInk = function updateInk() {
      ...
      if (linkNode && spanLinkNode.value) {
        spanLinkNode.value.style.top = "".concat(linkNode.offsetTop + linkNode.clientHeight / 2, "px");
        spanLinkNode.value.style.height = "".concat(linkNode.clientHeight, "px");
      }
    };
    (0, _context.default)({
    ...
    var createNestedLink = function createNestedLink(options) {
      return Array.isArray(options) ? options.map(function (item) {
        return (0, _vue.createVNode)(_AnchorLink.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, item), {}, {
          "key": item.key
        }), {
          default: function _default() {
            return [createNestedLink(item.children)];
          }
        });
      }) : null;
    };
    ...
    return function () {
      ...
      var inkClass = (0, _classNames4.default)("".concat(pre, "-ink-ball"), (0, _defineProperty2.default)({}, "".concat(pre, "-ink-ball-visible"), activeLink.value));
      var wrapperClass = (0, _classNames4.default)(hashId.value, props.wrapperClass, "".concat(pre, "-wrapper"), (0, _defineProperty2.default)({}, "".concat(pre, "-rtl"), direction.value === 'rtl'));
