...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref3) {
    ...
    var filterDropdownOpen = (0, _vue.computed)(function () {
      return props.column.filterDropdownOpen || props.column.filterDropdownVisible;
    });
    var onFilterDropdownOpenChange = (0, _vue.computed)(function () {
    ...
    if (process.env.NODE_ENV !== 'production') {
      [['filterDropdownVisible', 'filterDropdownOpen', props.column.filterDropdownVisible], ['onFilterDropdownVisibleChange', 'onFilterDropdownOpenChange', props.column.onFilterDropdownVisibleChange]].forEach(function (_ref4) {
        var _ref5 = (0, _slicedToArray2.default)(_ref4, 3),
          ...
          newName = _ref5[1],
          prop = _ref5[2];
        (0, _devWarning.default)(prop === undefined || prop === null, 'Table', "`".concat(deprecatedName, "` is deprecated. Please use `").concat(newName, "` instead."));
      });
    }
