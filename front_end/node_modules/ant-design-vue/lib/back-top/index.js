  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      var divProps = (0, _extends2.default)((0, _extends2.default)({}, attrs), {
        onClick: scrollToTop,
        class: (_class = {}, (0, _defineProperty2.default)(_class, hashId.value, true), (0, _defineProperty2.default)(_class, "".concat(prefixCls.value), true), (0, _defineProperty2.default)(_class, "".concat(attrs.class), attrs.class), (0, _defineProperty2.default)(_class, "".concat(prefixCls.value, "-rtl"), direction.value === 'rtl'), _class)
      });
