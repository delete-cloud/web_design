    ...
    new (...args: any[]): {
        ...
        $props: Partial<{
            menu: Partial<import("vue").ExtractPropTypes<{
                ...
                items: import("vue").PropType<import("../menu/src/hooks/useItems").ItemType[]>;
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "menu" | "visible" | "open" | "disabled" | "align" | "danger" | "destroyPopupOnHide" | "forceRender" | "autofocus" | "overlayStyle" | "arrow" | "minOverlayWidthMatchTrigger">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
