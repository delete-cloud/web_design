  ...
  var QrCode = /*#__PURE__*/function () {
    ...
    (0, _createClass2.default)(QrCode, [{
      ...
      value: function getPenaltyScore() {
        ...
        var dark = 0;
        var _iterator = (0, _createForOfIteratorHelper2.default)(this.modules),
          _step;
        try {
      ...
      value: function encodeSegments(segs, ecl) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            var _iterator3 = (0, _createForOfIteratorHelper2.default)(seg.getData()),
              _step3;
            try {
      ...
      value: function reedSolomonComputeRemainder(data, divisor) {
        ...
        var _iterator4 = (0, _createForOfIteratorHelper2.default)(data),
          _step4;
        try {
  ...
  var QrSegment = /*#__PURE__*/function () {
    ...
    (0, _createClass2.default)(QrSegment, [{
      ...
      function makeBytes(data) {
        var bb = [];
        var _iterator5 = (0, _createForOfIteratorHelper2.default)(data),
          _step5;
        try {
      ...
      value: function getTotalBits(segs, version) {
        var result = 0;
        var _iterator6 = (0, _createForOfIteratorHelper2.default)(segs),
          _step6;
        try {
...
(function (qrcodegen) {
  ...
  (function (QrCode) {
     ...
     */
    var Ecc = /*#__PURE__*/(0, _createClass2.default)( /*-- Constructor and fields --*/
    function Ecc(
